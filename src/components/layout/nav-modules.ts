...
// Admin Panel'de bir modüle özel ikon atanabilsin diye küçük, sabit bir
// seçim kümesi — DB'de ikon adı (bu haritanın anahtarı) string olarak
// saklanır, keyfi bir lucide-react ikon adı değil (öngörülemez import
// şişmesini önler).
