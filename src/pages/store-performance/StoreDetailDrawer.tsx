...
import { useStoreDevices, useStoreIncidents, useStoreScoreHistory, scoreLevel, type StoreScorecard } from './useStorePerformance'
import type { Priority, TicketStatus } from '@/types/database'

export function StoreDetailDrawer({ store, onClose }: { store: StoreScorecard; onClose: () => void }) {
